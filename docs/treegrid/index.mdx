...
:::danger Pro Note
The TreeGrid component is available in the <strong>PRO</strong> version only.

:::


dhtmlxTreeGrid is a special extension for [dhtmlxGrid](/grid/index). This component allows showing the nested tabular data. Being a successor of Grid, TreeGrid inherits its API and common techniques of initialization and
