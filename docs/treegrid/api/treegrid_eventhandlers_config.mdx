...
<Short>
 adds event handlers to HTML elements of a custom template of a TreeGrid cell or to the HTML elements defined in the data set of TreeGrid
...
~~~
 ...
 treegrid/02_configuration/22_template_events.html
