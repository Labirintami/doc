...
<table class="webixdoc_links">
	<tbody>
        ...
        <tr>
			...
			<td>(<i>array</i>) an array of objects with header rows configuration. Each header object may include:
                <ul>
                    ...
                    <li><b>rowspan</b> - (<i>number</i>) the number of rows in a rowspan <br/> https://snippet.dhtmlx.com/t8iust6j	TreeGrid. Header spans</li>
        ...
        <tr>
			...
			<td>(<i>boolean</i>) if set to <i>true</i>, specifies the HTML content (inner HTML) of a column. If set to <i>false</i>, the content of the column cells will be displayed as a <i>string</i> value <br/> https://snippet.dhtmlx.com/iubccmoi	TreeGrid. Html In Data</td>
		</tr>
        <tr>
        ...
        <tr>
			...
			<td>(<i>number</i>) the maximal width to be set for a column <br/> https://snippet.dhtmlx.com/pyrloz7y	TreeGrid. Max Width</td>
		</tr>
        <tr>
			<td class="webixdoc_links0"><b>minWidth</b></td>
			<td>(<i>number</i>) the minimal width to be set for a column <br/> https://snippet.dhtmlx.com/cpgjyoxn	TreeGrid. Min Width</td>
		</tr>
        <tr>
...
This option implies that you can enable/disable editing of particular columns by setting the <strong>editable: true</strong> property in the configuration of a column:
...
You can specify the way of editing the cells of a Grid column depending on its content as simple inputs, select controls or date pickers. The type of the used editor is defined by the <strong>editorType</strong> property of a column.
...
:::note
If you specify the <strong>editable</strong> option in the configuration of Grid, then editing of a column with checkbox will always be enabled.1
:::
...
You can set the <strong>hidden:true</strong> property in the [config of a column](/treegrid/configuration#columns) so that it doesn't appear on a page.
...
https://snippet.dhtmlx.com/w3yg99la	TreeGrid. Hidden Columns
...
This way presupposes making each cells of TreeGrid capable of displaying the HTML content via using the [htmlEnable](/treegrid/api/treegrid_htmlenable_config) property in the configuration object of TreeGrid.
...
Starting from v7.0, you can add event handlers to the [HTML elements defined in the data set of TreeGrid](/treegrid/configuration#htmlcontentoftreegridcolumns) with the help of the treegrid/api/treegrid_eventhandlers_config.md configuration property, for instance:
...
You can disable the resizing of any column by setting the <strong>resizable:false</strong> property in the config of a column.
...
You can make separate columns sortable by specifying the [sortable:true](/treegrid/api/treegrid_sortable_config) property in the configuration of a column.
...
https://snippet.dhtmlx.com/o62liqew	TreeGrid. Spans Cells

<strong>Note</strong>, that if both the <strong>spans</strong> and [splitAt](/treegrid/configuration#frozencolumns) properties are set in the Grid config, the following rules will be applied:
...
There is also the possibility to enable/disable tooltips for separate columns or spans by using the <strong>tooltip</strong> option in the configuration object of the [columns](/treegrid/configuration#columns) or [spans](/treegrid/configuration#spans) accordingly:
