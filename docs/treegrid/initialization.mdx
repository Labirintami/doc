...
<strong>If you use dhtmlxTreeGrid standalone</strong>, you need to include 2 files:
...
<strong>If you use dhtmlxTreeGrid as a part of the Suite package</strong>, you need to include JS/CSS files of the dhtmlxSuite library:
...
- from an external file with the help of the <strong>load()</strong> method of data collection:
...
- from a local source using the <strong>parse</strong> method of data collection:
