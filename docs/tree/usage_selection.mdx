...
You can manipulate with Tree items via the API of the <strong>selection</strong> object. It is possible to select an item, remove selection, and get the id or even the object of a selected Tree item.
...
To select a particular Tree item, make use of the <strong>add()</strong> method of the <strong>selection</strong> object. As a parameter the method takes the id of an item. 
