...
<strong>If you use dhtmlxTree standalone</strong>, you need to include 2 files:
...
<strong>If you use dhtmlxTree as a part of the Suite package</strong>, you need to include JS/CSS files of the dhtmlxSuite library:
...
- to load data from a local source, use the <strong>parse()</strong> method of the Tree Collection object:
...
- to load data from an external file, use the <strong>load()</strong> method of the Tree Collection object:
