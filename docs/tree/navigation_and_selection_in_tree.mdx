...
When this method is set to <strong>false</strong>, the highlighting is switched off, while setting the method to <strong>true</strong> switches this feature on.
