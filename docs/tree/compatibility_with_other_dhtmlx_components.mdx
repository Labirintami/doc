...
the menu methods <strong>hideButtons/showButtons</strong> should be used.

Note: For more information on the above mentioned menu buttons refer to [Menu Guides](/menu/index).
