...
https://snippet.dhtmlx.com/oz4jd5hc	Tree. Basic Initialization
...
To save the current state of a tree, use the <strong>serialize</strong> method of Tree Collection. It converts the data of a tree into an array of JSON objects. 
