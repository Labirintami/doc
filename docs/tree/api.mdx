...
:::note
Improve descr of the returned object1
:::
...
:::note
Add state example, improve descr of the state object1
:::
...
:::note
Check the name and functionality of the method1
:::
