---
sidebar_label: Calendar2 Initialization
title: Calendar2 Initialization
---
...
- via the [value configuration](http://localhost:3000/calendar2/configuring#initially-selected-date) option 
- with the help of the [setValue method](http://localhost:3000/calendar2/operating_calendar)
