...
// -> {inputType: "password", label: "Password", placeholder: "<strong>*</strong>***", …}
...
:::note
The returned object can contain only the properties that are listed below for each control.1
:::
...
The returned object of the <strong>Button</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>DatePicker</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>Checkbox</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>CheckboxGroup</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>ColorPicker</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>Combo</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>Input</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>RadioGroup</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>Select</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>SimpleVault</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>Slider</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>Text</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>Textarea</strong> control can contain the following configuration attributes:
...
The returned object of the <strong>TimePicker</strong> control can contain the following configuration attributes:
