...
It is possible to change values of the following configuration attributes of the <strong>RadioGroup</strong> control:
...
It is possible to change values of the following configuration attributes of a <strong>radio button</strong> of the RadioGroup control:
