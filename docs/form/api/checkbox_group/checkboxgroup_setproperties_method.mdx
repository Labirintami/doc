...
It is possible to change values of the following configuration attributes of the <strong>CheckboxGroup</strong> control:
...
It is possible to change values of the following configuration attributes of a <strong>checkbox</strong> of the CheckboxGroup control:
