...
When calling without parameters or setting the <strong>silent</strong> parameter to *false*, the method invokes the [BeforeValidate](/form/api/textarea/textarea_beforevalidate_event) and [AfterValidate](/form/api/textarea/textarea_aftervalidate_event) events and visually modifies the control.
