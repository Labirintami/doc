...
:::note
Note, that the method allows changing values only for the properties that are listed below for each control.1
:::

Here are two ways of using the <strong>setProperties</strong> method:

1\. To change values for the available attributes of a separate control you need to pass two parameters to the method:

- <strong>arg</strong> - (*string*) the name of the control (or its id)
- <strong>properties</strong> - (*object*) an object with available attributes of the control and their new values
...
- <strong>arg</strong> - (*object*) an object with a set of <i>key:value</i> pairs where <i>key</i> is the name of the control (or its id) and <i>value</i> is an object with the available attributes of the control and their new values
...
It is possible to change the following configuration attributes of the <strong>Button</strong> control:
...
It is possible to change the following configuration attributes of the <strong>DatePicker</strong> control:
...
It is possible to change the following configuration attributes of the <strong>Checkbox</strong> control:
...
It is possible to change the following configuration attributes of the <strong>CheckboxGroup</strong> control:
...
It is possible to change the following configuration attributes of the <strong>ColorPicker</strong> control:
...
It is possible to change the following configuration attributes of the <strong>Combo</strong> control:
...
It is possible to change the following configuration attributes of the <strong>Input</strong> control:
...
It is possible to change the following configuration attributes of the <strong>RadioGroup</strong> control:
...
It is possible to change the following configuration attributes of the <strong>Select</strong> control:
...
It is possible to change the following configuration attributes of the <strong>SimpleVault</strong> control:
...
It is possible to change the following configuration attributes of the <strong>Slider</strong> control:
...
It is possible to change the following configuration attributes of the <strong>Spacer</strong> control:
...
It is possible to change the following configuration attributes of the <strong>Text</strong> control:
...
It is possible to change the following configuration attributes of the <strong>Textarea</strong> control:
...
It is possible to change the following configuration attributes of the <strong>TimePicker</strong> control:
