...
You can apply various options of alignment for different [control groups](/form/configuration#groupingcontrolsinform) by specifying the form/api/form_align_property.md property for the form/api/form_rows_property.md and form/api/form_cols_property.md:
...
The tables below demonstrate using the possible values for the <strong>align</strong> property in Form:
...
To generate space around a [control group](/form/configuration#groupingcontrolsinform), make use of the form/api/form_padding_property.md parameter:
...
You can define a title for a [control group](/form/configuration#groupingcontrolsinform) with the help of the form/api/form_title_property.md property:
...
You can adjust sizes of a [control group](/form/configuration#groupingcontrolsinform) with the corresponding properties form/api/form_height_property.md and form/api/form_width_property.md:
