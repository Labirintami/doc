...
<table class="webixdoc_links">
	<tbody>
		...
		<tr>
			...
			<td>(<i>string</i>) the URL the post request with form data will be sent to (if the <b>submit</b> property is set to <i>true</i>)  <br/>https://snippet.dhtmlx.com/ikyyekxq	Form. All DhxForm Inputs</td>
		</tr>
		<tr>
...
You can manipulate a Button control by using methods (or [events](#eventhandling)) of the object returned by the [getItem()](/form/api/form_getitem_method) method.
