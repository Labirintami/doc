...
https://snippet.dhtmlx.com/9q8fubjm	Form. Inputs
...
You can manipulate a Input control by using methods (or [events](#eventhandling)) of the object returned by the [getItem()](/form/api/form_getitem_method) method.
