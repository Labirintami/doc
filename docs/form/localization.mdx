...
- apply the language settings by calling the <strong>dhx.i18n.setLocale()</strong> method before Form initialization:
...
https://snippet.dhtmlx.com/x8n18cr4	Form. Localization
