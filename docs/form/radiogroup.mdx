...
https://snippet.dhtmlx.com/ycp1cbct	Form. Radio Buttons
...
You can manipulate a RadioGroup control by using methods (or [events](#eventhandling)) of the object returned by the [getItem()](/form/api/form_getitem_method) method.
