...
https://snippet.dhtmlx.com/wla7u1xq	Form. Combo
...
You can manipulate a Combo control by using methods (or [events](#eventhandling)) of the object returned by the [getItem()](/form/api/form_getitem_method) method.
...
There is a possibility to use methods of dhtmlxCombobox via the <strong>getWidget()</strong> method of a Combo control.
