...
https://snippet.dhtmlx.com/yo9w9o2t	Form. Select
...
You can manipulate a Select control by using methods (or [events](#eventhandling)) of the object returned by the [getItem()](/form/api/form_getitem_method) method.
