...
https://snippet.dhtmlx.com/q3yk7e6s	Form. DatePicker
...
You can manipulate a DatePicker control by using methods (or [events](#eventhandling)) of the object returned by the [getItem()](/form/api/form_getitem_method) method.
...
There is a possibility to use methods of dhtmlxCalendar via the <strong>getWidget()</strong> method of a DatePicker control.
