...
in addition to <strong>dragMode</strong>:
...
:::note
The usage of the *CSS calc() function* within the dataview/api/dataview_itemheight_config.md property is not possible.1
:::
...
:::note
The usage of the *CSS calc() function* within the dataview/api/dataview_height_config.md property is not possible.1
:::
