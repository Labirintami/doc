...
<br/>
If you want to apply your own styles for selection of items or focus, you can do it via the corresponding CSS classes: <strong>.dhx_dataview-item--selected</strong> and <strong>.dhx_dataview-item--focus</strong>.
