...
But we recommended you to use the corresponding [getFocus()](/dataview/api/dataview_getfocus_method)/[setFocus()](/dataview/api/dataview_setfocus_method) methods for getting the id of an item in focus and setting focus to an item by its id:
