...
- apply the language settings by calling the <strong>dhx.i18n.setLocale()</strong> method before ColorPicker initialization:
...
https://snippet.dhtmlx.com/l870h1gh	Colorpicker. Localization