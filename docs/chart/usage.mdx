...
You can change configuration of Chart on the fly with the help of the chart/api/chart_setconfig_method.md method. It takes as a parameter an object with updated [chart configuration](/chart/configuration_properties).
...
The API of [Data Collection](/data_collection/api/refs/datacollection) allows you to perform operations with Chart data items. 
...
https://snippet.dhtmlx.com/dpz4w5nr	Chart. Adding Data On The Fly
