...
<strong>If you use dhtmlxChart standalone</strong>, you need to include 2 files:
...
<strong>If you use dhtmlxChart as a part of the Suite package</strong>, you need to include JS/CSS files of the dhtmlxSuite library:
...
https://snippet.dhtmlx.com/qah8exx2	Chart. Load Data
