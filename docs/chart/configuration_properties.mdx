...
- chart/api/chart_type_config.md - (*string*) defines the [type of a chart](/chart/charts_overview) to initialize; "bar", "x-bar" (for horizontal Bar chart), "line", "spline", "scatter", "area", 
...
There are "left","right","top","bottom" and "radial" (for Radar chart) types of [scales](/chart/api/chart_scales_config). Scales have both common and specific options.
...
<table class="webixdoc_links">
	<tbody>
        ...
        <tr>
			...
			<td>(<i>string</i>) sets a title for a scale <br/>https://snippet.dhtmlx.com/5ir00fer	Chart. Scale Title</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>(<i>function</i>) sets a template for scale labels <br/>https://snippet.dhtmlx.com/nhm3438n	Chart. Text Template For Scale Labels</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>(<i>number</i>) the degree of rotation of labels of data items on the scale <br/>https://snippet.dhtmlx.com/iw00fgl5	Chart. Scale Rotate</td>
		</tr>
		<tr>
...
<br/> https://snippet.dhtmlx.com/leqdx9qr	Chart. Grid</td>
		</tr>
		<tr>
			<td class="webixdoc_links0"><b>dashed</b></td>
			<td>(<i>boolean</i>) sets the dashed type for a scale. Use the <i>dashed:true</i> option in the configuration of the scale <br/>https://snippet.dhtmlx.com/gnj1xc3r	Chart. Dashed Grid</td>
		</tr>
		<tr>
			<td class="webixdoc_links0"><b>targetLine</b></td>
			<td>(<i>number</i>) shows a threshold line (a target value); looks for the specified value in the data <br/>https://snippet.dhtmlx.com/0h6n0yuy	Chart. Target Line</td>
		</tr>
		<tr>
			<td class="webixdoc_links0"><b>targetValue</b></td>
			<td>(<i>number</i>) allows setting a threshold line at any defined level (any number, not necessarily from the data) <br/>https://snippet.dhtmlx.com/8d9kgw28	Chart. Target Value</td>
		</tr>
		<tr>
...
The <strong>radial</strong> scale is used for Radar chart and has its own properties, due to peculiarities of configuration:
...
https://snippet.dhtmlx.com/yksfvhhl	Chart. Axis Configuration

Series
------------

[Series](/chart/api/chart_series_config) present an array of objects each of which contains a number of properties for rendering a separate [data set](/chart/data_loading#preparingdataset) on a chart.
	...
	<tbody>
    	<tr>
       	...
       	<tr>
			...
			<td>(<i>function</i>) a function that defines a color gradient for bars <br/>https://snippet.dhtmlx.com/j3duyn2q	Chart. Bar Gradient </td>
		</tr>
		<tr>
			<td class="webixdoc_links0"><b>type</b></td>
		...
		<tr>
			...
			<td>(<i>string</i>) sets the type of the point of the data item. There are the following point types:"circle","rect","triangle","rhombus","simpleRect","simpleCircle","empty" <br/>https://snippet.dhtmlx.com/cbj54wwu	Chart. Point Types </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>(<i>function</i>) a function that defines a template for showing values of data items in tooltip <br/>https://snippet.dhtmlx.com/mbz7dkku	Chart. Tooltip Template</td>
		</tr>
    </tbody>
</table>
<br/>
...
<table class="webixdoc_links">
	<tbody>
        <tr>
			...
			<td>(<i>number</i>) sets a base line for rendering data items (bars) <br/>https://snippet.dhtmlx.com/6tls4qhf	Chart. Base Line</td>
		</tr>
		<tr>
			<td class="webixdoc_links0"><b>stacked</b></td>
			<td>(<i>boolean</i>) defines whether a stacked chart will be rendered  <br/>https://snippet.dhtmlx.com/ilew1ds4	Chart. Stacked Chart</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>(<i>number|string</i>) the degree of rotation of text values of data items in bars <br/>https://snippet.dhtmlx.com/o7ke2f1s	Chart. Show Text</td>
		</tr>
    </tbody>
</table>
<br/>
...
<table class="webixdoc_links">
	<tbody>
        <tr>
			...
			<td>(<i>string</i>) the form of the legend markers ("rect" or "circle")<br/>https://snippet.dhtmlx.com/n8wsfv5n	Chart. Legend Form</td>
		</tr>
		<tr>
