...
You can find out more about Window properties in the [Configuration](/window/configuration) article. The possibilities of adjusting the look and feel of the Window header and footer are described in the
[Customization](/window/customization) article.
