...
You can read more information about [Configuration of a cell](/layout/configuration#configurationofcell) and  about [Styling of Layout cells](/layout/customization#stylinglayoutcells).
