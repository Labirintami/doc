...
@template:	api_config
@descr: 
The DHTMLX library provides a set of CSS classes that you can apply to change appearance of Pager.

~~~js
var chart = new dhx.Pager("pager_container", {
...
@relatedsample:
pager/04_customization/01_custom_style.html
