...
- specify the name of the created CSS class (or names of classes separated by spaces) as the value of the [css](/pager/api/pager_css_config) property in the Pager configuration:
