...
:::note
The usage of the *CSS calc() function* within the list/api/list_itemheight_config.md property is not possible.1
:::

When the [virtual](/list/api/list_virtual_config) property is set to *true*, the default height of a list item is 37. To change this value, make use of the <strong>itemHeight</strong> property, as described above.
...
:::note
The usage of the *CSS calc() function* within the list/api/list_height_config.md property is not possible.1
:::
...
- <strong>item</strong> - (*object*) an object of a data item
