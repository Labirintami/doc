...
But we recommended you to use the corresponding [getFocus()](/list/api/list_getfocus_method)/[setFocus()](/list/api/list_setfocus_method) methods for getting the id of an item in focus and setting focus to an item by its id:
