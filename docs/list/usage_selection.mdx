...
You can manipulate with List items via the API of the <strong>selection</strong> object. It is possible to select an item, remove selection, and get the id or even the object of a selected List item.
...
To select a particular List item, make use of the <strong>add()</strong> method of the <strong>selection</strong> object. As a parameter the method takes the id of an item. 
...
https://snippet.dhtmlx.com/io8oxxg2	List. Set Selection
...
https://snippet.dhtmlx.com/elonnovx	List. Get Selection
