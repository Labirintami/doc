...
https://snippet.dhtmlx.com/anj2keoc	List. Basic Initialization
...
- to load data from a local source, use the <strong>parse()</strong> method of the Data Collection object:
...
- to load data from an external file, use the <strong>load()</strong> method of the Data Collection object:
