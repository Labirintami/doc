...
:::note
Check the <a href="https://snippet.dhtmlx.com/q3cu6x1a"  target="_blank">example in our Snippet Tool</a> to try out the functionality on your touch devices.1
:::
...
- <strong>Double Tap</strong> - to edit items
- <strong>Press and Hold</strong> - to call the context menu
- <strong>Drag</strong> - to resize and reorder items, to change the value in Slider, ColorPicker, or TimePicker
