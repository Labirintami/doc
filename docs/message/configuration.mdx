...
<table class="webixdoc_links">
	<tbody>
        ...
        <tr>
			...
			<td>(<i>string</i>) optional, the HTML content to be displayed in a message box <br/> https://snippet.dhtmlx.com/1stqqejp	Message. Message With Html Content</td>
		</tr>
        <tr>
        ...
        <tr>
			...
			<td>(<i>string</i>) optional, the position of a message box:"top-left"|"top-right"|"bottom-left"|"bottom-right" <br/> https://snippet.dhtmlx.com/3wxrafmo	Message. Message Container</td>
		</tr>
        <tr>
...
https://snippet.dhtmlx.com/qfmd877x	Message. Message Configuration
...
https://snippet.dhtmlx.com/dk4a7959	Message. Alert And Confirm Configuration
...
https://snippet.dhtmlx.com/4wrrsr67	Message. Tooltip Position

https://snippet.dhtmlx.com/zts0avym	Message. Tooltip Delay Configuration

###Smart positioning

:::note
If the target of the tooltip is placed close to some edge of the browser, the tooltip will be shown from the opposite side of the target.1
:::
...
- to switch the tooltip off, use the <strong>disableTooltip()</strong> method:

~~~js
dhx.disableTooltip();
~~~

- to switch the tooltip on again, apply the <strong>enableTooltip()</strong> method:
