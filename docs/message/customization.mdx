...
- specify the name of the created CSS class (or names of classes separated by spaces) as the value of the <strong>css</strong> property in the [message box](/message/configuration#messagebox) ([alert](/message/configuration#alertbox), [confirm](/message/configuration#confirmbox)), [tooltip](/message/configuration#tooltip) configuration:
...
https://snippet.dhtmlx.com/7s6p67ht	Message. Message Custom Styles


https://snippet.dhtmlx.com/g9tba9xi	Message. Alert Custom Styles

https://snippet.dhtmlx.com/x0barf98	Message. Confirm Custom Styles
