...
What's Next todo
-----------
It's high time to embed RichText into your application to enrich it with editing abilities. The [How to start](../docs/) tutorial is ready to help your on your way.
