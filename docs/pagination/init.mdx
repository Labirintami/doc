...
:::note
dhtmlxPagination can be used in conjunction with data components like [List](/list/index), [DataView](/dataview/index), [Tree](/tree/index), [Grid](/grid/index), or [TreeGrid](/treegrid/index).1
:::
