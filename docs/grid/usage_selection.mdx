...
:::note
The <strong>multiselection</strong> property is disabled.1
:::
...
For that, manipulate the <strong>ctrlUp</strong> and <strong>shiftUp</strong> parameters accordingly:
...
:::note
Use the <strong>selection:"rows"</strong> property to be able to operate rows. 1
:::
