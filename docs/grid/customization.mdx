...
https://snippet.dhtmlx.com/xs7bixmg	Grid. Styling Selection
...
https://snippet.dhtmlx.com/c5tr3s5r	Grid. Styling Grid
...
You can easily set some styling to the text of header cells by applying some inline style or a CSS class to the <strong>text</strong> property of the header of a column:
...
https://snippet.dhtmlx.com/7o4elf48	Grid. Styling Header Cells


Styling footer cells
-------------------

You can easily set some styling to the text of footer cells by applying some inline style or a CSS class to the <strong>text</strong> property of the footer of a column:
...
https://snippet.dhtmlx.com/d254hcvp	Grid. Styling Footer Cells
...
- via the <strong>rowCss</strong> property in the configuration of Grid. As a value of property set a function that takes the id of a row as a parameter and returns a string with the name of a CSS class.
...
- with the help of the <strong>addRowCss()</strong> method:
...
It is easy to style necessary cells using the <strong>addCellCss()</strong> method. It takes three parameters:
...
You can mark particular cells in a grid using the <strong>mark</strong> property of a column configuration. You need to set its value as a function that takes the following parameters:
...
https://snippet.dhtmlx.com/buirf16n	Grid. Mark Cells
...
It is possible to customize the content of cells of Grid via the <strong>template</strong> property of a [column configuration](/grid/configuration#columns). The template option is a function that takes three parameters:
...
https://snippet.dhtmlx.com/9txizaow	Grid. Cell Templates
