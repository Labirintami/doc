...
https://snippet.dhtmlx.com/w3p07d6s	Grid. Large Dataset
...
You can specify data you want to add into Grid on the initialization stage. Make use of the <strong>data</strong> configuration property, as in:
...
https://snippet.dhtmlx.com/luh8d0vv	Grid. Basic Initialization
...
To save the current state of a grid, use the <strong>serialize</strong> method of Data Collection. It converts the data of a grid into an array of JSON objects. 
...
-  load data into Grid via the <strong>load</strong> method of Data Collection and pass `lazyDataProxy` as a parameter of this method:
...
https://snippet.dhtmlx.com/grid_lazy_loading	External data lazy load

:::note
The add, remove, copy, move, update, changeId, sort and filter methods of Data Collection will not work until all data are loaded into Grid.1
:::
