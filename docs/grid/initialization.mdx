...
<strong>If you use dhtmlxGrid standalone</strong>, you need to include 2 files:
...
<strong>If you use dhtmlxGrid as a part of the Suite package</strong>, you need to include JS/CSS files of the dhtmlxSuite library:
