...
- specify the name of the created CSS class (or names of classes separated by spaces) as the value of the [css](/combo/api/combobox_css_config) property in the ComboBox configuration:
...
https://snippet.dhtmlx.com/lldd739i	Combobox. Custom CSS
