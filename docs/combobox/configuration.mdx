...
- <strong>count</strong> - (*number*) the number of selected options
...
:::note
Don't forget to enable the <strong>multiselection</strong> option to select several options at once.1
:::
