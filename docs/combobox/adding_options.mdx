...
You can specify your own template of rendering Combo options with the help of the [template](/combo/api/combobox_template_config) configuration option.

:::note
Note that <strong>value</strong> is a mandatory property for a dataset item and <strong>src</strong> is a reserved one.1
:::
...
https://snippet.dhtmlx.com/69jnq5cn	Combobox. Basic Initialization
...
To save the current state of a combo box, use the <strong>serialize</strong> method of Data Collection. It converts the data of a combo box into an array of JSON objects. 
