...
- apply the language settings by calling the <strong>dhx.i18n.setLocale()</strong> method before Combobox initialization:
...
https://snippet.dhtmlx.com/cnj0j9g0	Combobox. Localization
