...
<strong>e</strong> is the mouse event. You can attach dhtmlxContextMenu to it:
...
- to the <strong>right</strong> of the element,
- at the <strong>bottom</strong> of the element,
- <strong>at</strong> the point where the mouse pointer is (default).
