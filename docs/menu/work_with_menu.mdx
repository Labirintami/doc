...
To get the selected items, call the [getSelected()](/ribbon/api/ribbon_getselected_method) method. The method returns an array of string values with IDs of selected items:
...
You can manipulate the controls of Menu with the help of the [Tree collection API](/tree_collection/api/refs/treecollection). 


### Adding menu items

You can add menu items with the <strong>add()</strong> method of tree collection:
...
https://snippet.dhtmlx.com/nood4bfx	Menu. Add/Remove Item

### Rearranging menu items

You can move menu items to different positions with the <strong>move()</strong> method. For example, this is how you can move an item with ID "2" to the left edge of the menu:
...
To get the current position, use the <strong>getIndex()</strong> method of TreeCollection:
...
You can work with all (or some) menu items with the help of the <strong>map()</strong> method of TreeCollection:
...
You can set text labels for any menu item. Access the needed item with the <strong>getItem()</strong> method of the TreeCollection:
...
You can add a shortcut to a menu option by accessing it with the help of the <strong>getItem()</strong> method. After you add a hotkey, a label with the keys will be added to the option.
...
You can remove any item from a menu with the <strong>remove()</strong> method. The item will be removed with all its sub-items.
...
To remove all items from Menu, call the <strong>removeAll()</strong> method. Afterwards, you can load other options.
