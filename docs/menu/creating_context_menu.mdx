...
https://snippet.dhtmlx.com/mgya9p1l	Menu. Basic Context Menu Initialization
...
dhtmlxContextMenu is attached to a context zone, and can be shown with the <strong>showAt()</strong> method. It takes two parameters:
...
- <strong>e</strong> is the mouse event.
