...
To operate Menu controls, you can use Menu API and [Tree Collection API](/helpers/tree_collection). Check the related article.
...
- <strong>type</strong> - (*string*) required, the item type, set it to "separator"
- <strong>id</strong> - (*string*) the ID of a control, automatically generated if you do not set it
...
- <strong>type</strong> - (*string*) required, the type of a control, set it to "spacer"
- <strong>id</strong> - (*string*) the ID of a control, automatically generated if you do not set it
