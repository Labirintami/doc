...
dhtmlxMenu uses the [icons of the DHTMLX library](/helpers/icon) by default. However, you can use any other icon font pack, if necessary. For this, you need to include the desired icon font on 
...
Then you can use the name of the icon as the value of the <strong>icon</strong> property in the [object with the control parameters](/menu/from_script#jsonformattemplates) for menu:
...
https://snippet.dhtmlx.com/nkmz6ilv	Menu. Custom Icons
...
https://snippet.dhtmlx.com/kfy2th5n	Menu. Custom Css
