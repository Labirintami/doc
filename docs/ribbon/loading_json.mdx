...
You can load data to a ribbon from an array with the <strong>parse()</strong> method of TreeCollection. Pass [a predefined data set](#preparingdataset) as a parameter of this method:

~~~js
ribbon.data.parse(data);
~~~

https://snippet.dhtmlx.com/1gd5tbcf	Ribbon. Initialization

Loading from an external file
------------------

The <strong>load</strong> method loads the ribbon data from an external JSON file. All the data are loaded at once. The parameter of the method is the path to the JSON file.
...
To save the current state of a ribbon, use the <strong>serialize()</strong> method of Tree Collection. It converts the data of a ribbon into an array of JSON objects. 
...
The <strong>Block</strong> object has the following properties:
...
The <strong>button</strong> object has the following properties:
...
<table class="webixdoc_links">
	<tbody>
        ...
        <tr>
			...
			<td>(<i>string</i>) defines the size of a button: "small"|"medium"|"auto" <br/> https://snippet.dhtmlx.com/1ayiafd1	Ribbon. Button Height</td>
		</tr>
        <tr>
...
The <strong>customHTML</strong> object has the following properties:
...
The <strong>imageButton</strong> object has the following properties:
...
The <strong>input</strong> object has the following properties:
...
The <strong>navItem</strong> object has the following properties:
...
The <strong>selectButton</strong> object has the following properties:
...
The <strong>separator</strong> object has the following properties:
...
The <strong>spacer</strong> object has the following properties:
...
The <strong>title</strong> object has the following properties:
