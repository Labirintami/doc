...
https://snippet.dhtmlx.com/yr8oepq8	Ribbon. Blocks
...
A block can be added to a ribbon with the help of the <strong>add()</strong> method of TreeCollection:
...
<strong>add()</strong> in this case receives three parameters:
...
You can add any custom HTML content to an item of the block with the help of the <strong>html</strong> property:
...
To hide/show a block, you should pass its ID to the <strong>hide() / show()</strong> methods:
