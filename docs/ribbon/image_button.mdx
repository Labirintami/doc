...
ImageButton can be easily added to a ribbon with the help of the <strong>add()</strong> method of the <strong>data</strong> module:
...
You can perform operations over the <strong>imageButton</strong> control with the help of the available [Ribbon API](/ribbon/api/refs/ribbon) and [Tree Collection API](/tree_collection/api/refs/treecollection).
