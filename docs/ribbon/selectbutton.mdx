...
A new SelectButton can be created with the help of the <strong>add()</strong> method of Tree Collection:
...
https://snippet.dhtmlx.com/5acqc24m	Ribbon. Select Button
...
You can perform operations over the SelectButton control with the help of the available [Ribbon API](/ribbon/api/refs/ribbon) and [Tree Collection API](/tree_collection/api/refs/treecollection).
