...
- by using [attachHTML()](/popup/api/popup_attachhtml_method) to attach some HTML content into a popup 
...
- by calling [attach()](/popup/api/popup_attach_method) to add other DHTMLX components into a popup
