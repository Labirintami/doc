...
1. The <strong>skin</strong> parameter of the dhtmxlPopup object constructor
2. The <strong>dhtmlx.skin</strong> property
...
For example, if you include on the page the only css file - "dhxpopup_dhx_terrace" - and instantiate dhtmlxPopup without specifying the <strong>skin</strong> parameter, then the "dhx_terrace" skin will be detected automatically. 
