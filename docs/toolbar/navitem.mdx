...
https://snippet.dhtmlx.com/os48cj6x	Toolbar. Nav Item

Adding NavItem
----------------

A navItem can be easily added to a toolbar with the help of the <strong>add()</strong> method of [Tree Collection](/tree_collection/api/refs/treecollection):
...
To hide/show a navItem, you should pass the ID of the navItem to the [hide()](/toolbar/api/toolbar_hide_method) / [show()](/toolbar/api/toolbar_show_method) Toolbar methods:
...
You can also enable and disable any navItem with the [enable()](/toolbar/api/toolbar_enable_method)/[disable()](/toolbar/api/toolbar_disable_method) methods of Toolbar:
