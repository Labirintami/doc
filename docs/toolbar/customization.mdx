...
dhtmlxToolbar uses the [icons of the DHTMLX library](/helpers/icon) by default. However, you can use any other icon font pack, if necessary. For this, you need to include the desired icon font on 
...
Then you can use the name of the icon as the value of the <strong>icon</strong> property in the [object with the control parameters](/toolbar/load_data#jsonformattemplates) for toolbar:
...
- specify the name of the created CSS class (or names of classes separated by spaces) as the value of the [css](/toolbar/api/toolbar_css_config) property in the Toolbar configuration:
