...
https://snippet.dhtmlx.com/ykd0uii1	Toolbar. Input

## Adding Input

The following example shows how an Input control can be easily added to a toolbar with the help of the <strong>add()</strong> method of [Tree Collection](/tree_collection/api/refs/treecollection):
...
You can show or hide Input with the [show()](/toolbar/api/toolbar_show_method)/[hide()](/toolbar/api/toolbar_hide_method) methods of Toolbar:
...
You can also enable and disable inputs with the [enable()](/toolbar/api/toolbar_enable_method)/[disable()](/toolbar/api/toolbar_disable_method) methods of Toolbar:
...
You can use the [setState()](/toolbar/api/toolbar_setstate_method) and [getState()](/toolbar/api/toolbar_getstate_method) methods of Toolbar to change and access the value of Input.
...
Check the full list of available operations in the [Toolbar API](/toolbar/api/refs/toolbar) and [Tree Collection API](/tree_collection/api/refs/treecollection).
