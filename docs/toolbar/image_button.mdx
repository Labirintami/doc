...
https://snippet.dhtmlx.com/vdiha09g	Toolbar. Image Button

## Adding ImageButton

ImageButton can be easily added to a toolbar with the help of the <strong>add()</strong> method of [Tree Collection](/tree_collection/api/refs/treecollection):
