...
1\. The <strong>views</strong> array contains a set of objects that describe configuration of tabs. Each tab object may include the following properties:
...
3\. Here are some notes on defining the sizes of a tab when the [mode](/tabbar/api/tabbar_mode_config) option is set in the configuration object of a Tabbar:
...
tabbar/configuring_tabbar.md#structureoftabs 
 ...
 tabbar/02_configuration/06_tab_size.html



<strong>tabWidth</strong> and <strong>tabHeight</strong> properties of a tab object are added in v7.0.
