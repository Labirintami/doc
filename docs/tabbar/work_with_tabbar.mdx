...
The [removeTab()](/tabbar/api/tabbar_removetab_method) method expects the id of a tab you want to remove as its parameter. You can get the id of a tab via the [getId()](/tabbar/api/tabbar_getid_method) method:
...
In order to get the id of a tab, make use of the [getId()](/tabbar/api/tabbar_getid_method) method. It takes the index of the tab in question as a parameter:
...
It is possible to set the active tab via Tabbar API, i.e. with the help of the [setActive()](/tabbar/api/tabbar_setactive_method) method. It takes the id of a tab as a parameter:
...
To identify what tab is currently active, apply the [getActive()](/tabbar/api/tabbar_getactive_method) method. It will return the id of the active tab.
...
--------------------------
To enable a tab, use the [enableTab()](/tabbar/api/tabbar_enabletab_method) method:

~~~js
tabbar.enableTab("London");
~~~

To disable a tab, use the [disableTab()](/tabbar/api/tabbar_disabletab_method) method:
...
To check if a tab is disabled, pass the id of the tab as an argument to the [isDisabled()](/tabbar/api/tabbar_isdisabled_method) method:

~~~js
tabbar.isDisabled("London"); // -> returns true/false
~~~

To check if a currently active tab is disabled, call the [isDisabled()](/tabbar/api/tabbar_isdisabled_method) method without parameters:
...
https://snippet.dhtmlx.com/o1jwmw1l	Tabbar. Attach
