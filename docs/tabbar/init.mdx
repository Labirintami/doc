...
https://snippet.dhtmlx.com/uysfjo5z	Tabbar. Basic Initialization
...
For example, Tabbar can have 4 tabs. You need to define their configuration objects and place them into the <strong>views</strong> array, like this:
