...
:::note
All the available default icons are presented in the <a href="https://snippet.dhtmlx.com/6vuv448f"  target="_blank">related sample</a>.1
:::


The icons can be placed on the page in the ways given below:

- via the <strong>icon</strong> property of controls

Use the name of the icon as a value of the <strong>icon</strong> property in the object with parameters of a control.
...
- through the <strong>template</strong> configuration property of the component
...
- via the <strong>attachHTML()</strong> method
...
- via the <strong>HTML</strong> configuration property of the component
...
:::note
You can use the name of an icon from the used icon font in the same way, if necessary. For example, you can use the [Font Awesome](https://fontawesome.com/) or [Material Design](https://materialdesignicons.com/) icon packs.
1
::: 
