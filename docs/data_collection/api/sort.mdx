...
The <strong>rule</strong> object has the following attributes:
...
:::note
Calling the method without parameters will discard all applied sorting rules.1
:::

The <strong>config</strong> parameter may contain one property:
...
To set a custom function for sorting you need to specify the <strong>rule</strong> attribute in a passed object. For example:
...
~~~
 ...
 https://snippet.dhtmlx.com/lz351u47	Data. Sort

 
The <strong>config</strong> parameter is added in v7.0. 