...
Calling the <strong>filter()</strong> method without parameters reverts the component to the initial state:
...
<br/>
The <strong>rule</strong> parameter:
...
<br/><br/>
The <strong>config</strong> parameter may contain two properties:
...
~~~
 ...
 https://snippet.dhtmlx.com/csiwq3kj	Data. Filter
