...
https://snippet.dhtmlx.com/6qqezjxe	Window. Basic Initialization
...
:::note
Don't use <strong>window</strong> as a variable name for dhxWindow object, since it is reserved for the browser window.1
:::
...
:::note
To show a created window on a page, you should call the [show()](/window/api/window_show_method) method after initialization of the component.1
:::
