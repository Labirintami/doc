...
- [left](/window/api/window_show_method) - (*number*) the left margin of a window
- [top](/window/api/window_show_method) - (*number*) the top margin of a window
...
- [width](/window/api/window_setsize_method) - (*number*) the width of a window
- [height](/window/api/window_setsize_method) - (*number*) the height of a window
...
- [left](/window/api/window_setposition_method) - (*number*)	the left coordinate of a window
- [top](/window/api/window_setposition_method) - (*number*)	the top coordinate of a window
