...
:::note
The [API of version 5.1](https://docs.dhtmlx.com/api__refs__dhtmlxwindows.html) is still available, but it is incompatible with the [API of version 6.0](/window/temp_api_windows).1
:::
