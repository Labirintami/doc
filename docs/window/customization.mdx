...
Then you can use the name of the icon as the value of the <strong>icon</strong> property in the object with the control parameters for the header or the footer. [See details below](/window/customization#updatecontrols).

https://snippet.dhtmlx.com/ucozvx01	Window. Custom Icons
...
https://snippet.dhtmlx.com/t5mvhwx8	Window. Custom Styles
