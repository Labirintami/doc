...
https://snippet.dhtmlx.com/scq85iip	Timepicker. Basic Initialization
...
Initialize TimePicker with the <strong>`dhx.Timepicker`</strong> object constructor. The constructor has two parameters:
...
You can set initial value for TimePicker using the <strong>setValue()</strong> method. It takes as a parameter the value to be set as a object Date, a string, or an array. Check details in the API reference.
