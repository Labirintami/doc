...
In v7.0, the <strong>apply</strong> event of TimePicker has been deprecated. Instead of it, use the new <strong>beforeApply</strong> and <strong>afterApply</strong> events:
