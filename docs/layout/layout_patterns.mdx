...
Layout patterns are predefined combinations of [rows and columns](/layout/layout_structure) that provide you with various options of arranging cells inside of a layout in a neat structure.
