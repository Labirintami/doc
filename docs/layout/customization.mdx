...
- specify the name of the created CSS class (or names of classes separated by spaces) as the value of the [css](/layout/api/layout_css_config) property in the configuration of a Layout cell:
...
https://snippet.dhtmlx.com/pwxmf0lx	Layout. Custom Css