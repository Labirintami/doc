...
:::note
Note, that [minWidth](/layout/api/layout_minwidth_config)/[maxWidth](/layout/api/layout_maxwidth_config) properties prevent [the width of a cell](/layout/api/layout_width_config) from being less/greater than minWidth/maxWidth values accordingly. The [minHeight](/layout/api/layout_minheight_config)/[maxHeight](/layout/api/layout_maxheight_config) options work in the same way. 1
:::
...
Starting with v7.0, you can configure a cell so that its width/ height would automatically adjust to the width/ height of the cell content. For this purpose, you need to set the [width](/layout/api/layout_width_config)/ [height](/layout/api/layout_height_config) options to *"content"*:
...
https://snippet.dhtmlx.com/r2e0y6n7	Layout. Accordion
...
:::note
Starting from v7.0, you can define the resizing limits by setting necessary values to the [minWidth](/layout/api/layout_minwidth_config)/[maxWidth](/layout/api/layout_maxwidth_config), [minHeight](/layout/api/layout_minheight_config)/[maxHeight](/layout/api/layout_maxheight_config) properties in the config of a cell.1
:::
...
https://snippet.dhtmlx.com/9ge1a4zx	Layout.Type
