...
- from an external file with the help of the <strong>load()</strong> method of tree collection:
...
- from a local source using the <strong>parse()</strong> method of tree collection:
