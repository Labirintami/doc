...
You can load data to a sidebar from an array with the <strong>parse()</strong> method of TreeCollection. Pass [a predefined data set](#preparingdataset) as a parameter of this method:

~~~js
sidebar.data.parse(data);
~~~

https://snippet.dhtmlx.com/x0qpt7pk	Sidebar. Basic Initialization

Loading from an external file
------------------

The <strong>load</strong> method loads the sidebar data from an external JSON file. All the data are loaded at once. The parameter of the method is the path to the JSON file.

~~~js
sidebar.data.load("[path to this file]/file.json");
~~~	

https://snippet.dhtmlx.com/mq4ggjmm	Sidebar. Init Load
...
To save the current state of a sidebar, use the <strong>serialize()</strong> method of Tree Collection. It converts the data of a sidebar into an array of JSON objects. 
