...
- <strong>state</strong> - (*object*) a hash of *key:value* pairs, where key is the ID of a control and value is a new value/state of the control
...
- <strong>state</strong> - (*object*) an object with IDs of controls and their values/states 
...
- <strong>isCollapsed</strong> - (*boolean*)	true, if a sidebar is collapsed
