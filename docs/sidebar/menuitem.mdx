...
A menuItem can be easily added to a sidebar with the help of the <strong>add()</strong> method of Tree Collection:
...
A menuItem can have an icon which is set through the corresponding option <strong>icon</strong>:
...
You can add a number badge to the menuItem to display information like the number of new messages. The badge is set via the <strong>count</strong> property:
...
You can add any custom HTML content to a menuItem with the help of the <strong>html</strong> property:
...
To hide/show a menuItem, you should pass the ID of the menuItem to the <strong>hide() / show()</strong> Sidebar methods:
