...
- <strong>"calendar"</strong> - shows the days of a month, the default mode
- <strong>"month"</strong> - allows selecting a month of a year
- <strong>"year"</strong> - allows selecting a year
- <strong>"timepicker"</strong> - allows showing calendar in the timepicker mode
...
~~~
- descr:
By default, it is either the same as <strong>value</strong>, or shows the current date, if <strong>value</strong> is not specified.
...
- descr: You can define the format of displaying time in a timepicker via the <strong>timeFormat</strong> property
...
|<strong>%H</strong>			|hours 24-format with leading zero, 01..24		|
|<strong>%G</strong>			|hours 24-format, 1..24							|
...
|<strong>%P</strong>			|timezone offset								|
