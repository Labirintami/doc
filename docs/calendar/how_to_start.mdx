...
https://snippet.dhtmlx.com/xcw19e52	Calendar. Basic Initialization
...
<strong>If you use dhtmlxCalendar standalone</strong>, you need to include 2 files:
...
<strong>If you use dhtmlxCalendar as a part of the Suite package</strong>, you need to include JS/CSS files of the dhtmlxSuite library:
...
This variant pressupposes that you create a popup first and then attach a calendar into it, thus creating a [date picker](/calendar/datepicker).
...
https://snippet.dhtmlx.com/mj7jr6ro	Calendar. Date Picker
