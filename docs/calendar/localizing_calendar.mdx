...
- apply the language settings by calling the <strong>dhx.i18n.setLocale()</strong> method before Calendar initialization:
...
https://snippet.dhtmlx.com/tn40a0w8	Calendar. Localized Calendar
```todo