...
:::note
Please note that the format of date in the Calendar is defined by the dateFormat option. So, check that you've set the format of date you want to use in the calendar both in the <strong>value</strong> and in the <strong>dateFormat</strong> property. Otherwise, the default format ("%d/%m/%y") will be used.1
:::
